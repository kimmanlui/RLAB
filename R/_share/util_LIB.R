...
mail2_OLD=function(subject="hello world", attachment=list(), pic=NULL, pic2=NULL, pic3=NULL, pic4=NULL, body=c(0,0,0,0), tips=FALSE, addr=globalDefaultEmailAddr,smtp="auto",senderAddr="cskmlui@hotmail.com", engine="java")
{
  if (smtp=="auto")
  {
    smtp="netvigator"
    thisHost=getHostName()
    if (thisHost %in% c("lsdmapple." ,  "ubn-Virtua")) smtp="polyu"      
  } else
  {
    smtp="netvigator" 
  }
...
mail2=function(subject="hello world", attachment=list(), pic=NULL, pic2=NULL, pic3=NULL, pic4=NULL, body=c(0,0,0,0), tips=FALSE, addr=globalDefaultEmailAddr,smtp="netvigator",senderAddr="cskmlui@hotmail.com", engine="java")
{
  force=0
  if (smtp=="auto")
  {
...
getET=function()
{
  tt =  getURL("http://www.etnet.com.hk/www/eng/futures/index.php")
  rht=readHTMLTable(tt)
  hp=htmlParse(tt)
  cur=xpathApply(hp, "/html/body/div[1]/div[3]/div[1]/div[1]/div[2]/div[1]/div[3]/div[2]/div[1]/span/node()"
                 ,xmlValue)[[1]]
  tmpstring=xpathApply(hp, "/html/body/div[1]/div[3]/div[1]/div[1]/div[2]/div[1]/div[3]/div[3]/div[1]"
                       ,xmlValue)
...
u.getSymbols=function (Symbols = "^hsi") 
{
  if (is.null(Symbols)) 
    return(NULL)
  base_url <- paste0("https://finance.yahoo.com/quote/", Symbols, "/history?p=", Symbols)
  library(httr)
  r = GET(base_url)
...
if (file.exists("/Users/admin/Documents/Dropbox/weblib/R/_shared/jdbc.R")) 
{
